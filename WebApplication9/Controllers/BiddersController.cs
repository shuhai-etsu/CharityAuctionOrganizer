...
namespace WebApplication9.Controllers
{
    public class BiddersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Bidder_ID,First_Name,Last_Name,Street_Name,Street_Number,Suite_Number,Bidder_City,Bidder_State,Bidder_Zip,Bidder_Email,Join_Society")] Bidder bidder)
        {
